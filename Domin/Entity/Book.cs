...
namespace Domin.Entity
{
    public class Book
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Ressources.ResourceData), ErrorMessageResourceName = ("BookName"))]
        ...
        [Required(ErrorMessageResourceType = typeof(Ressources.ResourceData), ErrorMessageResourceName = ("AthorName"))]
        [MaxLength(20, ErrorMessageResourceType = typeof(Ressources.ResourceData), ErrorMessageResourceName = ("MaxLength"))]
        [MinLength(3, ErrorMessageResourceType = typeof(Ressources.ResourceData), ErrorMessageResourceName = ("MinLength"))]
